...
const Users: FC = () => {
  ...
  const onDelete = (user: IUser) => {
    ...
    dispatch({
      type: AdminActionTypes.SET_MODAL_CONTENT,
      payload:
        "Are you sure you want to delete this user? This action will delete all his questions too.",
    });
  ...
  return (
    <>
      {loading ? (
        ...
        <Table onDelete={onDelete} objectArray={users} />
      ) : null}
    </>
  );
};
